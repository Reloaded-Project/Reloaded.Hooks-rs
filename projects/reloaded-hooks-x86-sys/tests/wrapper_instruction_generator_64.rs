...
pub mod tests {
    ...
    use reloaded_hooks_x86_sys::x64::Register::{self, *};
    use smallvec::smallvec;

    // EXTRA TESTS //

    #[test]
    fn ms_msft_to_systemv_unoptimized_with_call_absolute() {
        ...
        assert_eq!(vec[2], Pop::new(rcx).into()); // pop left param into reg
    ...
    */
    ...
    fn get_common_options<'a>(
        ...
        WrapperInstructionGeneratorOptions {
            ...
            jit_capabilities: JitX64::get_jit_capabilities(),
