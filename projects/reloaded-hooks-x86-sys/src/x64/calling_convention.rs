...
impl<'a> CallingConvention<'a> {
    ...
    pub fn microsoft_x64() -> Self {
        static INT_PARAMS: [Register; 4] = [rcx, rdx, r8, r9];
        static FLOAT_PARAMS: [Register; 4] = [xmm0, xmm1, xmm2, xmm3];
        static CALLEE_SAVED: [Register; 18] = [
    ...
    pub fn system_v_amd64() -> Self {
        static INT_PARAMS: [Register; 6] = [rdi, rsi, rdx, rcx, r8, r9];
        static FLOAT_PARAMS: [Register; 8] = [xmm0, xmm1, xmm2, xmm3, xmm4, xmm5, xmm6, xmm7];

        static CALLEE_SAVED: [Register; 14] = [
    ...
    /// Returns an instance of the CallingConvention struct configured for the
    /// System V AMD64 calling convention, commonly used in Unix-like systems.
    pub fn system_v_amd64_ymm() -> Self {
        static INT_PARAMS: [Register; 6] = [rdi, rsi, rdx, rcx, r8, r9];
        static FLOAT_PARAMS: [Register; 8] = [ymm0, ymm1, ymm2, ymm3, ymm4, ymm5, ymm6, ymm7];
    ...
    /// Returns an instance of the CallingConvention struct configured for the
    /// System V AMD64 calling convention, commonly used in Unix-like systems.
    pub fn system_v_amd64_zmm() -> Self {
        static INT_PARAMS: [Register; 6] = [rdi, rsi, rdx, rcx, r8, r9];
        static FLOAT_PARAMS: [Register; 8] = [zmm0, zmm1, zmm2, zmm3, zmm4, zmm5, zmm6, zmm7];
        static CALLEE_SAVED: [Register; 14] = [
