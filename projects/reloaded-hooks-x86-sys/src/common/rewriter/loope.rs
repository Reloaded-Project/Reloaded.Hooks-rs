...
#[cfg(feature = "x86")]
pub(crate) fn patch_loope_32<TRegister>(
...
fn encode_rel32(
    ...
    *dest_address += INS_SIZE_REL;
    ...
    unsafe {
        ...
        // loope 0x4 + jmp +5 (fixed)
        write_unaligned(ptr as *mut u32, 0x05EB_02E1_u32.to_le());
...
pub(crate) fn patch_loope_64(
    ...
    /*
        ...
        Relocated: (E1 02 EB 05 E9 F3 FF FF 07)
        - loope +2                   ---+
        - jmp 0x11                     |  --+
    ...
    *dest_address += INS_SIZE_ABS;
    ...
    unsafe {
        ...
        write_unaligned(ptr as *mut u32, 0x0CEB_02E1_u32.to_le());
...
mod tests {
    ...
    fn relocate_loope_32(
        ...
        test_relocate_instruction(
            ...
            false,
            patch_loope_32, // the function being tested
        );
    }
    ...
    fn relocate_loope_64(
        ...
        test_relocate_instruction(
            ...
            true,
            patch_loope_64, // the function being tested
        );
    }
}
