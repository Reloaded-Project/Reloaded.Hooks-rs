...
impl LengthDisassembler for LengthDisassemblerAarch64 {
    fn disassemble_length(_code_address: usize, min_length: usize) -> usize {
...
mod tests {
    ...
    #[rstest]
    #[case::single_ins("410040f9", 4, 4)]
    #[case::two_instructions("830040f9830040f9", 8, 8)]
    #[case::non_aligned_min_length("830040f9830040f9", 5, 8)]
